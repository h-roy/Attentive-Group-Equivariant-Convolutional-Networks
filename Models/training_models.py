...
class P4AllCNNC(nn.Module):
    def __init__(self, use_bias=False):
        ...
        import importlib
        group_name = 'SE2'
        group = importlib.import_module('AttentionLayers.group.' + group_name)
        # Import the gsplintes package and the layers
        import AttentionLayers
        se2_layers = AttentionLayers.layers(group)  # The layers is instantiated with the group structure as input
    ...
    def forward(self, x):
        ...
        # Visualize
        if False:
            from AttentionLayers.attention_layers import fSpatialAttentionGG
            from AttentionLayers.attention_layers import fSpatialAttention
            import numpy as np
...
class fA_P4AllCNNC(P4AllCNNC):
    ...
    def __init__(self):
        ...
        from AttentionLayers.attention_layers import fChannelAttention as ch_RnG
        from AttentionLayers.attention_layers import fChannelAttentionGG #as ch_GG
        from AttentionLayers.attention_layers import fSpatialAttention #as sp_RnG
        from AttentionLayers.attention_layers import fSpatialAttentionGG
...
class P4MAllCNNC(nn.Module):
    def __init__(self):
        ...
        # Import the gsplintes package and the layers
        import AttentionLayers
        e2_layers = AttentionLayers.layers(group)  # The layers is instantiated with the group structure as input
        # Create H grid for p4 group
...
class A_P4AllCNNC(P4AllCNNC):
    ...
    def __init__(self, use_bias=False, attention=False):
        ...
        from AttentionLayers.attention_layers import ChannelAttention as ch_RnG
        from AttentionLayers.attention_layers import ChannelAttentionGG #as ch_GG
        from AttentionLayers.attention_layers import SpatialAttention #as sp_RnG
        from AttentionLayers.attention_layers import SpatialAttentionGG
